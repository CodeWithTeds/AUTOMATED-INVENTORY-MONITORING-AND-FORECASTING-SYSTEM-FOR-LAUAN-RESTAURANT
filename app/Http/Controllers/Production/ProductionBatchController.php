...
class ProductionBatchController extends Controller
{
    ...
    {
        return Inertia::render('production/index', $this->productionBatchService->indexData($request->only(['search', 'status', 'inventory_item_id', 'production_area', 'sort', 'direction'])));
    }
