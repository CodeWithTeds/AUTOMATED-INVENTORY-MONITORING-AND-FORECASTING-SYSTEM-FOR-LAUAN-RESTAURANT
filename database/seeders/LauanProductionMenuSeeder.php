    ...
    private function rawMaterial(array $item): InventoryItem
    {
        return InventoryItem::query()->updateOrCreate(
            ...
            [
                ...
                'unit' => $item['raw_unit'],
                'current_stock' => 0,
                'starting_stock' => $item['raw_quantity'],
                'stock_in' => $item['raw_quantity'],
                'stock_out' => $item['raw_quantity'],
                'ending_stock' => 0,
    ...
    private function product(array $item): InventoryItem
    {
        return InventoryItem::query()->updateOrCreate(
            ...
            [
                ...
                'starting_stock' => $item['output'],
                'stock_in' => $item['output'],
                'stock_out' => 0,
                'ending_stock' => $item['output'],
